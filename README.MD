...
```bash
curl -sSfL https://raw.githubusercontent.com/DeerFishSheep/chatgpt-mirror-server-deploy/master/quick-install.sh | bash
...
```bash
git clone --depth=1 https://github.com/DeerFishSheep/chatgpt-mirror-server-deploy.git chatgpt-mirror
```
